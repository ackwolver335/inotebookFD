...
const Noteitem = (props) => {
    ...
    const {deleteNote} = context;                                  // destructuring regarding particular context

    // prop in order to get the note passed towards to main section
    ...
    return (
        ...
        <div className="noteCard bg-secondary/80 xsz:p-3 sm:p-4 xl:space-y-4 xsz:rounded-sm xsz:shadow-md xsz:space-y-3 md:space-y-4 lg:space-y-3">
            ...
            <div className="operationalIcons flex flex-row justify-start xsz:gap-4 sm:gap-5 items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-trash3 xsz:w-4 lg:w-5 text-primary cursor-pointer" viewBox="0 0 16 16" onClick={() => {deleteNote(note._id)}}>
                    <path d="M6.5 1h3a.5.5 0 0 1 .5.5v1H6v-1a.5.5 0 0 1 .5-.5M11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3A1.5 1.5 0 0 0 5 1.5v1H1.5a.5.5 0 0 0 0 1h.538l.853 10.66A2 2 0 0 0 4.885 16h6.23a2 2 0 0 0 1.994-1.84l.853-10.66h.538a.5.5 0 0 0 0-1zm1.958 1-.846 10.58a1 1 0 0 1-.997.92h-6.23a1 1 0 0 1-.997-.92L3.042 3.5zm-7.487 1a.5.5 0 0 1 .528.47l.5 8.5a.5.5 0 0 1-.998.06L5 5.03a.5.5 0 0 1 .47-.53Zm5.058 0a.5.5 0 0 1 .47.53l-.5 8.5a.5.5 0 1 1-.998-.06l.5-8.5a.5.5 0 0 1 .528-.47M8 4.5a.5.5 0 0 1 .5.5v8.5a.5.5 0 0 1-1 0V5a.5.5 0 0 1 .5-.5" />
                </svg>

                {/* Icon regarding Editing of the Note */}
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-pencil-square xsz:w-4 lg:w-5 text-primary cursor-pointer" viewBox="0 0 16 16" onClick={() => {updateNote(note)}}>
