  ...
  return (
    <>
      ...
      <div className="z-5 userNotes xsz:space-y-2 lg:space-y-3 bg-white/80 xsz:mx-3 xsz:my-3 xsz:rounded-md xsz:shadow-md xsz:py-3 xsz:px-4 xl:mx-6">
        ...
        <div className="notesBlock grid xsz:grid-flow-row xsz:space-y-3 sm:grid-flow-col sm:gap-4 xl:gap-5 sm:grid-rows-4 md:grid-rows-2 lg:grid-rows-3 xl:grid-rows-2 2xl:grid-rows-2 items-baseline">
          {notes.map((note) => {
